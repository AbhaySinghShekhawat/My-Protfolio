...
function Contact() {
  ...
  return (
    <section id="contact" className="section pb-20 pt-20 lg:pt-32 ">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 text-xl leading-tight font-semibold lg:text-3xl lg:leading-tight lg:max-w-[12ch]">
            Contact Me for Jobs or Collaboration
          </h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] ">
            ...
            learn, and grow as a web developer. Reach out today to discuss how I
            can help with your team or project — I’m excited to collaborate and
          ...
          <div className="flex items-center gap-2 mt-auto ">
            {socialLinks.map(({ href, icon, alt }, index) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/allzrjga"
          method="POST"
        ...
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="Abhaysingh@example.com"
                className="text-field "
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="btn btn-primary [&] max-w-full w-full  justify-center h-11 bg-sky-400 text-zinc-950 hover:bg-sky-300 cursor-pointer"
          >
            Submit
          </button>
        </form>
